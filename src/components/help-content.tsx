...
const helpData: { [key: string]: { title: string; steps: string[] }[] } = {
  ...
  planner: [
    ...
    },
    {
        ...
        steps: [
            "To remove an item, click the 'X' icon next to it.",
            "To clear the entire schedule and reset points, use the 'Clear Schedule' button.",
  ...
  phrases: [
    {
      ...
      steps: [
        ...
        "3. Click the speaker icon (Volume2) next to the phrase to have it spoken aloud.",
      ]
    },
    {
    ...
    },
    {
        ...
        steps: [
            ...
            "To delete a phrase, click the 'X' icon.",
