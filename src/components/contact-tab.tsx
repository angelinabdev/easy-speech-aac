    ...
    <Card>
        ...
        <CardContent className="space-y-6">
            <div className="p-4 border rounded-lg">
                ...
                <p className="text-sm text-muted-foreground mt-1 mb-3">For general inquiries and feedback, please use our contact form. We do our best to respond within a few days.</p>
